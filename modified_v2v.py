...
TRANSMISSION_RANGE = 500  # 차량의 전송 범위 (미터 단위)
...
def initialize_vehicle_positions(doca_start, num_lanes, num_vehicles_per_lane, speed):
    ...
    for i in range(num_vehicles_per_lane):
...
class Simulation:
    def __init__(self, scheduler):
        ...
        self.num_lanes = 4
        self.num_vehicles_per_lane = 12
        self.speed = 140
        self.doca_start, self.doca_end = 1000, 1500
        ...
        # Skipping original vehicle creation logic
